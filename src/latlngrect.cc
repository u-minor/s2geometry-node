...
Handle<Value> LatLngRect::New(const Arguments& args) {
    ...
    if (info.Length() == 1) {
        obj->this_ = S2LatLngRect(
            S2LatLngRect::FromPoint(Nan::Nan::ObjectWrap::Unwrap<LatLng>(ll)->get()));
        ...
        obj->this_ = S2LatLngRect(
            S2LatLngRect::FromPointPair(
                Nan::Nan::ObjectWrap::Unwrap<LatLng>(ll)->get(),
                Nan::Nan::ObjectWrap::Unwrap<LatLng>(llb)->get()));
    }
...
NAN_METHOD(LatLngRect::GetCenter) {
    Nan::HandleScope scope;
    LatLngRect* latlngrect = Nan::Nan::ObjectWrap::Unwrap<LatLngRect>(info.This());
...
NAN_METHOD(LatLngRect::Contains) {
    Nan::HandleScope scope;
    LatLngRect* latlngrect = Nan::Nan::ObjectWrap::Unwrap<LatLngRect>(info.This());
    S2LatLng other = Nan::Nan::ObjectWrap::Unwrap<LatLng>(info[0]->ToObject())->get();
...
NAN_METHOD(LatLngRect::Union) {
    Nan::HandleScope scope;
    LatLngRect* latlngrect = Nan::Nan::ObjectWrap::Unwrap<LatLngRect>(info.This());
    S2LatLngRect other = Nan::Nan::ObjectWrap::Unwrap<LatLngRect>(info[0]->ToObject())->get();
